package net.seeals.testmod.entity.animation;

//For more example of how animation works, check CamelEntity
...
//for this just copy the text file you got from blockbench lmfao
