...
import net.seeals.testmod.entity.animation.ModAnimations;
...
public class PorcupineModel<T extends PorcupineEntity> extends SinglePartEntityModel<T> {
	...
	public PorcupineModel(ModelPart root) {
		...
		this.head = porcupine.getChild("body").getChild("torso").getChild("head");	//this reference the layers in blockbench!
	}
	...
	//Values taken from camel. Makes it moves its head!
