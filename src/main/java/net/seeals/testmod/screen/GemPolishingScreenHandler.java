...
public class GemPolishingScreenHandler extends ScreenHandler {
    ...
    public GemPolishingScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
        super(ModScreenHandler.GEM_POLISHING_SCREEN_HANDLER, syncId);
    ...
    //For shift clicking purposes. Mostly same with some minor changes.
    @Override
    ...
    //These method will always be the same with some minor changes here and there.
