...
public enum ModArmorMaterial implements ArmorMaterial {
    ...
    //If you want to add new mod materials for armors!, just duplicate it here! Also check ArmorMaterials class!
    SAPPHIRE("sapphire", 25, new int[] { 3, 8, 6, 3 }, 19, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE,
    ...
    public String getName() {
        return TestMod.MOD_ID + ":" + this.name;                //if you don't do this, your mod ID won't be in front of the item's name!
    }
